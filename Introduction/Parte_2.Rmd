...
atenas <- comida[length(qualidade_comida)] #a função length() recebe como entrada, por exemplo, um vector ou um factor e retorna numero de elementos desse mesmo argumento de entrada.
